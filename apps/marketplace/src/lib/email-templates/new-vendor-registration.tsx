  ...
  return (
    <EmailLayout preview="New vendor registration">
      ...
      <Section className="my-4">
        <Text className="m-0 mb-1 text-xs font-semibold uppercase text-stone-500">
          Vendor name
        </Text>
        <Text className="m-0 mb-3 text-[15px] text-stone-600">
          {vendorName}
        </Text>
        <Text className="m-0 mb-1 text-xs font-semibold uppercase text-stone-500">
          Company name
        ...
        <Text className="m-0 mb-3 text-[15px] text-stone-600">{vatId}</Text>
        <Text className="m-0 mb-1 text-xs font-semibold uppercase text-stone-500">
          Contact email
        </Text>
        <Text className="m-0 mb-3 text-[15px] text-stone-600">
