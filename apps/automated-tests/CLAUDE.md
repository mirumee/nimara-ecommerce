...
- `codecept/` holds a single CodeceptJS homepage smoke test, configured by `codecept.conf.ts`. It is
  a trial with a review date, not the standard — Playwright remains the standard. Do not add new
  coverage there. See `docs/adr/0001-codeceptjs-spike.md`.
