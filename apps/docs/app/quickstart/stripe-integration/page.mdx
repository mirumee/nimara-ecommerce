...
The Nimara Stripe app is a standalone Python service that connects to Saleor via a manifest URL.
...
The Nimara Stripe Python App can be deployed using Docker or AWS (Lambda + Terraform).
