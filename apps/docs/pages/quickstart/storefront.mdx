...
This guide will help you set up a [Nimara storefront](https://www.nimara.store.com) in your local environment.
...
```bash
git clone https://github.com/mirumee/nimara-storefront.git nimara-storefront
