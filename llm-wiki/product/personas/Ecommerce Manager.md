...
### Goals
- Run a multi-channel, multi-locale store (markets, languages, currencies) without filing a dev ticket for every change.
...
- **Decision process:** Doesn't choose Nimara — inherits it from the developer/agency. But their frustration drives churn: if operations require dev tickets, the business switches platforms.
