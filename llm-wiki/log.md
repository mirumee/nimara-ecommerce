...
- **RFC**: Added the two competing RFCs for [PRD-001](prd/PRD-001%20Natural-Language%20Product%20Discovery.md) under `tech/RFC/Natural-Language Product Discovery/`, each beside its durable grilling log: [RFC-0001](tech/RFC/Natural-Language%20Product%20Discovery/RFC-0001%20Natural-Language%20Product%20Discovery.md) (Nimara-owned discovery layer over `SearchService`; hybrid query-plan + grounded re-rank; AWS Bedrock reference) and [RFC-0002](tech/RFC/Natural-Language%20Product%20Discovery/RFC-0002%20Provider-Native%20Natural-Language%20Product%20Discovery.md) (provider-native via Algolia Agent Studio). Registered in the [RFC MOC](tech/RFC/RFC%20MOC.md) and `index.md`; linked to PRD-001 both ways. The two are mutually exclusive — one ADR should resolve both.
