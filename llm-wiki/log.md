...
- **Provenance gap**: The endpoint-per-account claims in INT-0005, OPS-0002, and IMP-0002 are read from the working tree and are not committed. They carry a pending-change note instead of a permalink and must be anchored once that work lands.
