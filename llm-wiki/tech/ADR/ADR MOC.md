...
- [ADR-0004 Newsletter Capture Is A Selectable Provider Capability](ADR-0004%20Newsletter%20Capture%20Is%20A%20Selectable%20Provider%20Capability.md) - accepted - Newsletter capture layers over the existing provider-selection machinery, and the public submit path ships unbounded by decision.
