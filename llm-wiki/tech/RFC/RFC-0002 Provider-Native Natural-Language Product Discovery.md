...
Competing approach to [RFC-0001 Natural-Language Product Discovery](tech/RFC/RFC-0001%20Natural-Language%20Product%20Discovery.md), which serves the same PRD by building the discovery pipeline inside Nimara. The two are compared in [Alternative solutions](#alternative-solutions).
