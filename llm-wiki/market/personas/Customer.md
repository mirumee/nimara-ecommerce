...
type: "Persona"
title: "Customer"
description: "EXPERIENCE persona — the end buyer after purchase: has an order, an inbox, and expectations. Not a segment Nimara sells to: their post-purchase experience is the quality bar for fulfillment communication, reviews, and account features."
tags:
  - "persona"
  - "experience"
  - "end-user"
...
- Reliable fulfillment data is a prerequisite: invitation timing and review windows inherit their accuracy from stores marking orders fulfilled (an [Ecommerce Manager](Ecommerce%20Manager.md) workflow).
