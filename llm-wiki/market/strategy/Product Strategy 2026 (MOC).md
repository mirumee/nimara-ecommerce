...
- [Composable Commerce Market](../research/Composable%20Commerce%20Market.md) — market size, economics, the adoption bottleneck
- [Competitor Landscape](../research/Competitor%20Landscape.md) — Saleor, Medusa, commercetools, Alokai, Vendure, Hydrogen, Swell and more
- [Table Stakes vs Differentiators](../research/Table%20Stakes%20vs%20Differentiators.md) — what's commoditized vs Nimara's opportunity
- [Emerging Trends 2026](../research/Emerging%20Trends%202026.md) — agentic commerce, UCP/MCP, marketplaces, deploy-in-minutes DX
- [Developer Pain Points](../research/Developer%20Pain%20Points.md) — community feedback and competitor stability/security gaps
...
- [Initiative Prioritization](initiatives/Initiative%20Prioritization.md) — the ranked scoring table
  1. **Zero-to-Deploy CLI** — _Now_
  2. **Stripe Connect Split Payments** — _Now_
  3. **UCP-MCP Agentic Discovery** — _Next_
  4. **Auto-Invoicing & Regional Tax** — _Next_
  5. **Provider-Agnostic Interface** — _Later_
