...
- [Coverage Maps](quality/Coverage%20Maps.md) — equivalence partitions so you test _classes_, not random cases.
...
- [Stripe Connect Settlement Verification](quality/Stripe%20Connect%20Settlement%20Verification.md) — evidence map and production-readiness gaps from onboarding through ledger settlement and Transfers.
