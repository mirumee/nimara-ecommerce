...
export type ProductBaseFragment = { id: string, name: string, description: string | null, translation: ProductBaseFragment_Product_translation_ProductTranslation | null };
