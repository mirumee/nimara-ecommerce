...
export type OrderFragment = { id: string, created: string, number: string, displayGrossPrices: boolean, lines: Array<OrderFragment_Order_lines_OrderLine>, total: OrderFragment_Order_total_TaxedMoney };
