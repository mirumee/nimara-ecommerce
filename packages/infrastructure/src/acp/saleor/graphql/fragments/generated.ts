...
export type CheckoutSessionFragment_Checkout_lines_CheckoutLine_totalPrice_TaxedMoney_tax_Money = { currency: string, amount: number };
...
export type CheckoutSessionFragment_Checkout_lines_CheckoutLine_totalPrice_TaxedMoney = { net: CheckoutSessionFragment_Checkout_lines_CheckoutLine_totalPrice_TaxedMoney_net_Money, tax: CheckoutSessionFragment_Checkout_lines_CheckoutLine_totalPrice_TaxedMoney_tax_Money, gross: CheckoutSessionFragment_Checkout_lines_CheckoutLine_totalPrice_TaxedMoney_gross_Money };
...
export type CheckoutSessionFragment_Checkout_lines_CheckoutLine_variant_ProductVariant_product_Product = { id: string, slug: string, name: string, vendorId?: string | null, thumbnail: CheckoutSessionFragment_Checkout_lines_CheckoutLine_variant_ProductVariant_product_Product_thumbnail_Image | null, translation: CheckoutSessionFragment_Checkout_lines_CheckoutLine_variant_ProductVariant_product_Product_translation_ProductTranslation | null };
...
export type CheckoutSessionFragment_Checkout_problems =
  | CheckoutSessionFragment_Checkout_problems_CheckoutLineProblemInsufficientStock
