...
export type CartQuery_checkout_Checkout_lines_CheckoutLine_totalPrice_TaxedMoney_tax_Money = { currency: string, amount: number };
...
export type CartQuery_checkout_Checkout_lines_CheckoutLine_totalPrice_TaxedMoney = { net: CartQuery_checkout_Checkout_lines_CheckoutLine_totalPrice_TaxedMoney_net_Money, tax: CartQuery_checkout_Checkout_lines_CheckoutLine_totalPrice_TaxedMoney_tax_Money, gross: CartQuery_checkout_Checkout_lines_CheckoutLine_totalPrice_TaxedMoney_gross_Money };
...
export type CartQuery_checkout_Checkout_lines_CheckoutLine_variant_ProductVariant_product_Product = { id: string, slug: string, name: string, vendorId?: string | null, thumbnail: CartQuery_checkout_Checkout_lines_CheckoutLine_variant_ProductVariant_product_Product_thumbnail_Image | null, translation: CartQuery_checkout_Checkout_lines_CheckoutLine_variant_ProductVariant_product_Product_translation_ProductTranslation | null };
...
export type CartQuery_checkout_Checkout_problems =
  | CartQuery_checkout_Checkout_problems_CheckoutLineProblemInsufficientStock
  | CartQuery_checkout_Checkout_problems_CheckoutLineProblemVariantNotAvailable
;
