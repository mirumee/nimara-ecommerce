...
export const UcpCheckoutSessionUpdateDocument = new TypedDocumentString(`
    mutation UCPCheckoutSessionUpdate($checkoutId: ID!, $shippingAddress: AddressInput!, $shouldUpdateShipping: Boolean!, $billingAddress: AddressInput!, $shouldUpdateBilling: Boolean!, $buyerEmail: String!, $buyerJSON: String!, $shouldUpdateEmail: Boolean!, $fulfillmentAddressJSON: String!, $fulfillmentOptionID: ID!, $shouldUpdateFulfillmentOption: Boolean!) {
