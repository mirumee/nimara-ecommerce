...
export type UcpCatalogLookup_products_ProductCountableConnection_edges_ProductCountableEdge_node_Product_variants_ProductVariant_attributes_SelectedAttribute_attribute_Attribute = { name: string, slug: string };
...
export type UcpCatalogLookup_products_ProductCountableConnection_edges_ProductCountableEdge_node_Product_productType_ProductType_variantAttributes_Attribute = { name: string, slug: string, choices: UcpCatalogLookup_products_ProductCountableConnection_edges_ProductCountableEdge_node_Product_productType_ProductType_variantAttributes_Attribute_choices_AttributeValueCountableConnection | null };
