...
import { type CollectionViewProps } from "../shared/types";
 ...
 */
export const StandardCollectionView = async (props: CollectionViewProps) => {
            ...
            render={({ collection, pageInfo, searchParams }) => {
                ...
                return (
                    <div className="mb-8 grid w-full gap-8">
                        <Breadcrumbs pageName={collection.name} homePath={props.paths.home} />
                        <CollectionHeader
