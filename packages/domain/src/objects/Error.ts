 ...
 * @description Generic API error. This type is used to represent errors that are not validation errors.
 */
...
export interface PaymentError extends BaseError {
  /*
   * The error code from the payment gateway.
   */
 ...
 */
export type AppError = GenericApiError | PaymentError;
